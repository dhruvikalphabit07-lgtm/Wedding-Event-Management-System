                ...
                <div class="col col-lg-5" style="margin-top: 10%;">
                    ...
                    <p class="lead text-center" style="color:white;">START BY FILLING UP THE FORM</p>
                        ...
                        <div class="text-center mt-3">
                            <p style="font-size: 11px;color:white;">By clicking "Book inquiry" you agree to WPMS's <a
                            ...
                            <button type="submit" name="register" class="btn btn-danger btn-sm text-uppercase fb"
                                    style="margin-top: -5px;">Book inquiry
                            </button>
                        </div>
                    </form>
                </div>
    ...
    <div class="row">
        <div class="col-12 col-md">
            <div class="text-center">
                <small class="d-block mb-3 text-muted">&copy; <?php echo date('Y')?> Developed By Dhruv & Dhruvik </small>
            </div>
        </div>
    </div>
</footer>
